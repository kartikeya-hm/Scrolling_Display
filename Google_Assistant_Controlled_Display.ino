 ...
 * This Project has been done by students of 2nd year EIE, KMIT ( Kartikeya, Prudhvi  Pranav ) ( 07/11/2019 )
 */
/************************* Necessary Libraries *********************************/
...
void setup()
{
  ...
  strcpy(curMessage, "Hello , we are from EIE 2nd Year ");
  newMessage[0] = '\0';
